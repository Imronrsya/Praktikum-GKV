...
void draw() {
    float radius_outer = 20.0;
    float radius_inner = 7.0;
    float height = 10.0;
    int num_points = 5;
    ...
    for (int i = 0; i <= num_points * 2; i++) {
        ...
        float radius = (i % 2 == 0) ? radius_outer : radius_inner;
...
void help() {
    printf("Proyeksi contoh bayangan sebuah objek bintang berwarna merah\n");
}
...
int main(int argc, char *argv[]) {
    ...
    glutCreateWindow("Proyeksi Bayangan Bintang");
